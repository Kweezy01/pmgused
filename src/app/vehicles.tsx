...
//     const data = await api.vehicle.getLatest();
//    if (!data) return (<h1>Team not found</h1>)
//     const [latestVehicle] = data;
...
//                             {[latestVehicle?.teamName, latestVehicle?.angler1, latestVehicle?.angler2, latestVehicle?.totalFish, latestVehicle?.totalWeight, latestVehicle?.recordedGames].map((e) => {
//                                 return (
